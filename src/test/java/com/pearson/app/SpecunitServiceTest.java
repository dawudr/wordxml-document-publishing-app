...
public class SpecunitServiceTest {
    ...
    public void setup() {
        ...
        specunit.setUnitXML(fullUnitXml);
    ...
    public void testFindSpecunitById() {
        ...
        Specunit resultSpecunit = specUnitService.getSpecUnitById(1);
    ...
    public void testFindUserByQan() {
        Specunit specunit = new Specunit();
        specunit.setQanNo("S/111/1111");
        specunit.setUnitXML(TransformationServiceTest.textXml);
        specUnitService.addSpecUnit(specunit);

        Specunit resultSpecunit = specUnitService.getSpecUnitByQanNo("S/111/1111");
        assertNotNull("specunit is mandatory",resultSpecunit);
        assertTrue("Unexpected specunit " + resultSpecunit.getQanNo(), resultSpecunit.getQanNo().equals("S/111/1111"));
        System.out.println("specunit -> " +  resultSpecunit);
    ...
    public void testCreateValidSpecunit() {
        Specunit specunit = new Specunit();
        specunit.setQanNo("S/111/1124");
        specunit.setUnitXML(TransformationServiceTest.textXml);
        specUnitService.addSpecUnit(specunit);

        Specunit newSpecunit = specUnitService.getSpecUnitByQanNo("S/111/2222");

        assertTrue("Specunit not expected " + newSpecunit.getQanNo(), "S/111/2222".equals(newSpecunit.getQanNo()) );
        ...
        System.out.println("SpecUnitId=" + newSpecunit.getQanNo());
    ...
    @Test
    public void testUpdateSpecUnitMetadata() {
        Specunit specunit = new Specunit();
        specunit.setQanNo("S/111/3333");
        specunit.setUnitXML(UnitMetaXml);
        //specUnitService.addSpecUnit(specunit);

        User user = userService.getUserByUsername("btectest");
        if(user == null) {
            userService.addUser(new User("btectest", "Password123", "Btec", "Test", "test@email.com", User.ROLE_ADMIN));
            user = userService.getUserByUsername("btectest");
        }
        Transformation transformation = transformationService.getTransformationByQan("S/111/3333");
        if(transformation == null) {
            Transformation newTransformation = new Transformation();
            newTransformation.setUser(user);
            newTransformation.setDate(new Date());
            newTransformation.setQanNo("S/111/3333");
            ...
            newTransformation.setIqsxmlfilename("S_OLD_1234.xml");
            ...
            Image firstImage = createImageRecord("S/111/3333");
            // Causes javax.persistence.PersistenceException: org.hibernate.PersistentObjectException: detached entity passed to persist: com.pearson.app.model.Image
        ...
        Transformation result_transformation = transformationService.getTransformationByQan("S/111/3333");
        TransformationDTO transformationDTO = new TransformationDTO(result_transformation);

        // Make changes
        transformationDTO.setQanNo("U/111/3333");
        ...
        // Assert if Updated
        Specunit result_specunit = specUnitService.getSpecUnitById(transformationDTO.getSpecunit());
        assertTrue("QAN not expected " + result_specunit.getQanNo(), "U/111/3333".equals(result_specunit.getQanNo()) );
        assertTrue("UAN in XML not expected " + result_specunit.getUnitXML(), result_specunit.getUnitXML().contains("<uan>U/111/3333</uan>"));
        assertTrue("UnitNo in XML not expected " + result_specunit.getUnitXML(), result_specunit.getUnitXML().contains("<unitnumber>00</unitnumber>"));
        assertTrue("UnitTitle in XML not expected " + result_specunit.getUnitXML(), result_specunit.getUnitXML().contains("<unittitle>NONE</unittitle>"));
        assertTrue("Author in XML not expected " + result_specunit.getUnitXML(), result_specunit.getUnitXML().contains("<author>Anonymous</author>"));



    }

    public static final String UnitMetaXml = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n" +
            "<unit>\n" +
            "  <uan>H/123/1234</uan>\n" +
    ...
    public static final String UnitMetaXml_Updated = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n" +
            "<unit>\n" +
            "  <uan>U/111/3333</uan>\n" +
            "  <dc-description>Missing</dc-description>\n" +
            "  <dc-title>BTEC 2016 Specification</dc-title>\n" +
    ...
    public static final String fullUnitXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
            "<unit>\n" +
            "  <uan>H/123/1234</uan>\n" +
            "  <dc-description>Missing</dc-description>\n" +
            "  <dc-title>BTEC 2016 Specification</dc-title>\n" +
