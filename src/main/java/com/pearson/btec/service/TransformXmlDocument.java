...
/**
 * Created by dawud on 12/03/2015.
 */
public class TransformXmlDocument {
    private final Logger LOGGER = LoggerFactory.getLogger(TransformXmlDocument.class);
    private String openXmlString;

    public TransformXmlDocument(String openXmlString) {
        this.openXmlString = openXmlString;
    }

    public String doTranformOpenXmlToIqsXml(String root) throws TransformerException, IOException {
        LOGGER.debug("In tranformOpenXmlToIqsXml Params: openXmlString[{}]", Specunit.truncate(this.openXmlString, 50));
        ...
        String xsltPath = root + AppURIConstants.TRANSFORM_SCRIPTS_XSLT_TAGGEDWORDOPENXML_PQSXML_FILE_PATH;
        //String xsltPath = "src/main/webapp/resources/xsl/iqs/wordxml_unit.xsl";

        LOGGER.debug("Transforming this.openXmlString[{}] with xsl[{}]", Specunit.truncate(this.openXmlString, 20), xsltPath);
        ...
        Reader reader = new StringReader(this.openXmlString);
    ...
    public static void main(String[] args) {
        ...
        TransformXmlDocument transformXmlDocument = new TransformXmlDocument(textXml);
        try {
                String root = "src/main/webapp";
            System.out.println(transformXmlDocument.doTranformOpenXmlToIqsXml(root));
