...
public class TransformationsDTO {
    ...
    public TransformationsDTO(long currentPage, long totalPages, List<TransformationDTO> transformations) {
        this.currentPage = currentPage;
        this.totalPages = totalPages;
        this.transformations = transformations;
    }

    public TransformationsDTO(List<TransformationDTO> transformations) {
        this.transformations = transformations;
    }
