...
public class TemplateRepository implements TemplateDAOInterface{
    ...
    public Template getTemplateByTemplateName(String templateName) {
        List<Template> templates = em.createNamedQuery(Template.FIND_BY_TEMPLATE_TYPE, Template.class)
    ...
    public boolean isTemplateNameAvailable(String templateName) {
        ...
        List<Template> users = em.createNamedQuery(Template.FIND_BY_TEMPLATE_TYPE, Template.class)
