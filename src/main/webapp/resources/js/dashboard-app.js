...
dashboardApp.controller('DashboardCtrl', function ($scope, $http, $filter) {
    ...
    $http.get('/transformation/list').success(function (data, filterFilter, $timeout) {
     ...
     $scope.lastUpdateDate = lastDate;
        ...
        $scope.filteredTransformations, $scope.filteredPagnTransformations = [];
...
.controller('DocumentTransformSingleCtrl', function ($scope, $http) {
    /**
...
.controller('TestCtrl', function ($scope, $log) {
     ...
     */
        ...
        $scope.numPages = function () {
            return Math.ceil($scope.transformationsTestData.length / $scope.numPerPage);
        };
        ...
        $scope.maxSize = 5;
        $scope.bigTotalItems = $scope.transformationsTestData.length;
