    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="page-header">
                <h2>File Transformed Successfully - <small>Select an action to continue</small></h2>
            </div>
            ...
            <table class="table table-striped">
                <tr>
                    ...
                    <tr>
                        <form class="form-horizontal" method="post" action='filedownload'>
                            <div class="control-group">
                                ...
                                <td>
                                    <button type="submit" class="btn btn-primary" name="convert" disabled="disabled">Transform</button>
                                </td>
                                <td><button type="submit" class="btn btn-primary" name="action" value="download-openxml">Download</button></td>
                                <td><button type="submit" class="btn btn-primary" name="action" value="download-iqsxml">Download</button></td>
                            </div>
                        </form>
                    </tr>
